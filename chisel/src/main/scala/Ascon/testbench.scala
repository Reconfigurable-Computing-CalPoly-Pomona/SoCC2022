...
class encryptBehavior(dut:ascon, pcycle:Int) extends PeekPokeTester(dut) {
...
class hashBehavior(dut: ascon, pcycle:Int) extends PeekPokeTester(dut) {
...
class newBehavior(dut: permutation_one_wrapper, pcycle:Int) extends PeekPokeTester(dut) {
